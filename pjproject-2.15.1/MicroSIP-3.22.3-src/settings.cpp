...
void AccountSettings::Init()
{
    ...
    ptr = autoAnswerCalls.GetBuffer(255);
    GetPrivateProfileString(section, _T("autoAnswerCalls"), NULL, ptr, 256, iniFile);
    ...
    ptr = str.GetBuffer(255);
    GetPrivateProfileString(section, _T("disableNameLookup"), NULL, ptr, 256, iniFile);
    str.ReleaseBuffer();
    ...
    ptr = str.GetBuffer(255);
    GetPrivateProfileString(section, _T("networkChanges"), _T("1"), ptr, 256, iniFile);
    str.ReleaseBuffer();
    ...
    ptr = clientApiHost.GetBuffer(255);
    GetPrivateProfileString(section, _T("clientApiHost"), _T("http://127.0.0.1:3000"), ptr, 256, iniFile);
    clientApiHost.ReleaseBuffer();
...
void AccountSettings::SettingsSave()
{
    ...
    WritePrivateProfileString(section, _T("buttonAC"), buttonAC ? _T("1") : _T("0"), iniFile);
    WritePrivateProfileString(section, _T("buttonCONF"), buttonCONF ? _T("1") : _T("0"), iniFile);
    ...
    WritePrivateProfileString(section, _T("autoAnswerCalls"), autoAnswerCalls, iniFile);
    ...
    WritePrivateProfileString(section, _T("disableNameLookup"), disableNameLookup ? _T("1") : _T("0"), iniFile);
    ...
    WritePrivateProfileString(section, _T("clientApiHost"), clientApiHost, iniFile);
