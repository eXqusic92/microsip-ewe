...
public:
	...
	MessagesContact* AddTab(CString number, BOOL activate = FALSE, pjsua_call_info *call_info = NULL, call_user_data *user_data = NULL, BOOL notShowWindow = FALSE, BOOL ifExists = FALSE, CString numberOriginal = _T(""), CString name = _T(""));
...
public:
	...
	afx_msg void OnBnClickedClientCard();
