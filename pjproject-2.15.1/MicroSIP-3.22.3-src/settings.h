...
struct AccountSettings {
	...
	CString autoAnswerCalls;
	CString forwarding;
	CString forwardingNumber;
	int forwardingDelay;
	bool FWD;
	CString featureCodeCP;
	CString featureCodeBT;
	CString featureCodeAT;
